...
type keybinding struct {
	...
	ch       rune
	mod      Modifier
	handler  func(*Gui, *View, interface{}) error
}

// newKeybinding returns a new Keybinding object.
func newKeybinding(viewname string, key Key, ch rune, mod Modifier, handler func(*Gui, *View, interface{}) error) (kb *keybinding) {
	kb = &keybinding{
		viewName: viewname,
		key:      key,
		ch:       ch,
